...
import static com.example.tugas_uts_akb_if3_10117118.Data.Sqlite.DatabaseAtribut.NoteColumns.DATE;
import static com.example.tugas_uts_akb_if3_10117118.Data.Sqlite.DatabaseAtribut.NoteColumns.NIM;
import static com.example.tugas_uts_akb_if3_10117118.Data.Sqlite.DatabaseAtribut.NoteColumns.KELAS;
import static com.example.tugas_uts_akb_if3_10117118.Data.Sqlite.DatabaseAtribut.NoteColumns.EMAIL;
import static com.example.tugas_uts_akb_if3_10117118.Data.Sqlite.DatabaseAtribut.NoteColumns.INSTAGRAM;
import static com.example.tugas_uts_akb_if3_10117118.Data.Sqlite.DatabaseAtribut.NoteColumns.TELPON;
import static com.example.tugas_uts_akb_if3_10117118.Data.Sqlite.DatabaseAtribut.NoteColumns.NAMA;
...
public class TemanUpdate extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_teman_update);
        ...
        if (v.getId() == R.id.btn_submit){
            ...
            if (isEdit){
                ...
                if (result > 0){
                    ...
                    Toast.makeText(TemanUpdate.this, "Gagal mengupdate data", Toast.LENGTH_SHORT).show();
                }
            }else {
                ...
                if (result > 0){
                    ...
                    Toast.makeText(TemanUpdate.this, "Gagal menambah data", Toast.LENGTH_SHORT).show();
                }
            }
        }
    }
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        if (isDialogClose){
                            ...
                            if (result > 0){
                               ...
                               Toast.makeText(TemanUpdate.this, "Gagal menghapus data", Toast.LENGTH_SHORT).show();
                            }
                        }
                    }
                })
